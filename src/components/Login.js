    ...
    <div className="login">
      <div className="holder">
        ...
        <div className="login-form-other">
          ...
          { page ? 'New to Fugly Clothing?' : 'Existing User'} &nbsp;
      ...
      <img className="concord-img vlv-creative" src="https://www.dpmarketingcommunications.com/wp-content/uploads/2020/05/AdobeStock_217537096-scaled.jpeg" alt="" />
    </div>
  )
}
